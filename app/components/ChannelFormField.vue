...
<template>
  <UFormField :name="channel.id" :description="channel.description"
    ...
    <Component v-if="channel.input?.is" :is="channel.input.is" v-bind="channel.input?.attrs" v-model="value"
      class="w-full" />
    <UInput v-else v-bind="channel.input?.attrs" v-model="value" class="w-full" :ui="{ trailing: 'pe-1' }">
