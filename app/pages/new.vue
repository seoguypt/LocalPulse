...
// TODO: Make this confirm with the user before updating the name and category
...
<template>
  <UContainer as="main" class="py-8">
    ...
    <UForm :schema="schema" :state="state" @submit="onSubmit">
      ...
      <UFormField label="Business Category" name="category" size="xl">
      ...
      <div class="space-y-4" v-if="false">
        ...
        <div class="grid grid-cols-3 gap-6">
          <ChannelCardField label="Website" name="websiteUrl" icon="i-lucide-globe"
            ...
            :model-value="state.websiteUrl ?? null" @update:model-value="value => state.websiteUrl = value" />

          <ChannelCardField label="Instagram" name="instagramUsername" icon="simple-icons-instagram"
            color="text-[#ED0191]"
            description="Visual platform for sharing product photos and connecting with younger audiences."
            :model-value="state.instagramUsername ?? null"
            @update:model-value="value => state.instagramUsername = value" />
          ...
          <ChannelCardField label="Facebook" name="facebookUsername" icon="logos-facebook"
            ...
            :model-value="state.facebookUsername ?? null"
            @update:model-value="value => state.facebookUsername = value" />
          ...
          <ChannelCardField label="TikTok" name="tiktokUsername" icon="logos-tiktok-icon"
            ...
            :model-value="state.tiktokUsername ?? null" @update:model-value="value => state.tiktokUsername = value" />

          <ChannelCardField label="Apple Maps for Business" name="appleMapsUsername" icon="logos-apple"
            color="text-gray-600"
            description="Help iOS users find your business location with essential business information."
            :model-value="state.appleMapsUsername ?? null"
            @update:model-value="value => state.appleMapsUsername = value" />
          ...
          <ChannelCardField label="Bing Places for Business" name="bingPlaceId" icon="logos-bing" color="text-[#028272]"
            ...
            :model-value="state.bingPlaceId ?? null" @update:model-value="value => state.bingPlaceId = value" />
          ...
          <ChannelCardField label="Uber Eats" name="uberEatsUrl" icon="simple-icons-ubereats" color="text-[#03C167]"
            ...
            :model-value="state.uberEatsUrl ?? null" @update:model-value="value => state.uberEatsUrl = value" />
          ...
          <ChannelCardField label="Deliveroo" name="deliverooUrl" icon="simple-icons-deliveroo" color="text-[#00CCBC]"
            ...
            :model-value="state.deliverooUrl ?? null" @update:model-value="value => state.deliverooUrl = value" />
          ...
          <ChannelCardField label="Doordash" name="doorDashUrl" icon="simple-icons-doordash" color="text-[#F44322]"
            ...
            :model-value="state.doorDashUrl ?? null" @update:model-value="value => state.doorDashUrl = value" />
          ...
          <ChannelCardField label="Menulog" name="menulogUrl" icon="i-lucide-hamburger" color="text-[#FF8001]"
            ...
            :model-value="state.menulogUrl ?? null" @update:model-value="value => state.menulogUrl = value" />
        </div>
      </div>
